...
const SearchExercises = ({ setExercises, bodyPart, setBodyPart }) => {
  ...
  return (
    <Stack alignItems="center" mt="37px" justifyContent="center" p="20px">
      <Typography fontWeight={700} sx={{ fontSize: { lg: '34px', xs: '20px' } }} mb="10px" textAlign="center">
      ...
      <Box position="relative" mb="72px">
        <TextField
          ...
          type="text"
        />
        <Button className="search-btn" sx={{ bgcolor: 'blue', color: 'gold', textTransform: 'none', width: { lg: '173px', xs: '80px' }, height: '56px', position: 'absolute', right: '0px', fontSize: { lg: '20px', xs: '14px' } }} onClick={handleSearch}>
          Search
        </Button>
      </Box>
